...
import (
	foov1alpha1 "ara-controller/pkg/apis/foo/v1alpha1"
	versioned "ara-controller/pkg/client/clientset/versioned"
	internalinterfaces "ara-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "ara-controller/pkg/client/listers/foo/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FooV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FooV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&foov1alpha1.Foo{},
		resyncPeriod,
