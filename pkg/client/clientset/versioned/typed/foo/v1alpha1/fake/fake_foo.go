...
import (
	v1alpha1 "ara-controller/pkg/apis/foo/v1alpha1"
...
var foosResource = schema.GroupVersionResource{Group: "foo.dsky.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "foo.dsky.io", Version: "v1alpha1", Kind: "Foo"}
